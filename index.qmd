...
This protocol was registered with the Open Science Framework (OSF): <https://doi.org/10.17605/OSF.IO/A4VMZ>.
...
Eligible articles were peer-reviewed, with BBB gas exchange data, human participants, in English, with a DOI.
...
Full texts were accessed via publisher text and data mining APIs using Python, [unpaywall.org](https://unpaywall.org/) using the unpywall Python package, through custom-built web-scraping scripts, or manually.
