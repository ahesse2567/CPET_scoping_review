...
See the supplemental methods for additional ML model details.
...
The initial search identified `r format(nrow(all_articles), big.mark = ',', scientific = FALSE)` articles; `r format(nrow(articles_unique), big.mark = ',', scientific = FALSE)` remained for retrieval after removing duplicates and those without DOIs.
