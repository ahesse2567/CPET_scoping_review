...
Our work parallels many aspects of @nolte2023 but searches without date restriction and includes studies with CPET data beyond VO~2~max ramp tests.
This larger sample may uncover an even broader set of data processing methods.
...
This may hamper reproduction or replication attempts, which have become a more prominent issue in science within the past decade [@goodman2016; @opensciencecollaboration2015].
Therefore, to assist with conducting future research on the effects of data processing on CPET values and to evaluate the methodological reproducibility of research using BBB gas exchange data generally, we conducted a broad scoping review to identify the frequency of reporting, and popularity of outlier removal, interpolation, and data averaging methods.
