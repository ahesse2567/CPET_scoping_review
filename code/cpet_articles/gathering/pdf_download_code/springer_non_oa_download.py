...
folder = '/Users/antonhesse/Desktop/Anton/Education/UMN/Lab and Research/HSPL/CPET_scoping_review/data/cpet_articles/pdfs/springer_non_oa_pdfs/'

query_status_code = []
pdf_status_code = []
pbar = tqdm(len(springer_non_oa_articles.index))

for i, row in springer_non_oa_articles.iterrows():
    query = row['doi']
    params = {
    'api_key': api_key,
    'q': query
