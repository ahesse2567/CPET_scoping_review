...
articles = remaining_articles[(all_articles['publisher'] == 'Elsevier BV') & \
    (remaining_articles['is_oa'] == False)].drop_duplicates().reset_index(drop=True)
articles.shape
...
folder = '/Users/antonhesse/Desktop/Anton/Education/UMN/Lab and Research/HSPL/CPET_scoping_review/data/cpet_articles/full_texts/txts/eslevier_non_oa_txts'
file_ext = 'txt'
...
merge.to_csv('/Users/antonhesse/Desktop/Anton/Education/UMN/Lab and Research/HSPL/CPET_scoping_review/data/cpet_articles/unpaywall/elsevier_non_oa_articles_status_codes.csv',
    index=False)
