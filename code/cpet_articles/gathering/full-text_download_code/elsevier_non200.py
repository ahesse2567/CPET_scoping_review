...
articles = pd.read_csv('data/cpet_articles/unpaywall/elsevier_non_oa_status_codes.csv')
...
api_key = config_info['apikey']
insttoken = config_info['insttoken']
...
"""
# Test code for a single article
