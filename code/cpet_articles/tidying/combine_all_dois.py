...
wos_recoreds = pd.read_csv('/Users/antonhesse/Desktop/Anton/Education/UMN/Lab and Research/HSPL/CPET_scoping_review/data/cpet_articles/web_of_science/wos_doi_merged.csv')

doi_df = pd.concat([ovid_records['doi'], scopus_records['doi'], wos_recoreds['doi']])
doi_df = doi_df.drop_duplicates().reset_index(drop=True)
