...
existing_txt_file_paths = list(Path('data/cpet_articles/full_texts/txts').rglob('*.txt'))
len(existing_txt_file_paths)
existing_txt_files = [path.stem for path in existing_txt_file_paths]

existing_pdf_file_paths = list(Path('data/cpet_articles/full_texts/pdfs').rglob('*.pdf'))
len(existing_pdf_file_paths)
existing_pdf_files = [path.stem for path in existing_pdf_file_paths]

full_text_folders = [folder for folder in list(Path('data/cpet_articles/full_texts').iterdir()) if folder.is_dir()]
