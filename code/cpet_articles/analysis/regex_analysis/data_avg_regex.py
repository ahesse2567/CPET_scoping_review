...
manual_text_analysis_path = Path('/Users/antonhesse/Desktop/Anton/Education/UMN/Lab and Research/HSPL/CPET_scoping_review/data/cpet_articles/text_analysis/Manual text analysis - Avg.csv')
...
merge_df = pd.merge(
    ...
    how='outer', on='doi_suffix').drop_duplicates(subset=['doi_suffix', 'Avg method'])
merge_df
merge_df['doi_suffix'] = merge_df['doi_suffix'].astype('str')
merge_df = reorder_columns(merge_df, 'avg_terms', position=3)
merge_df = reorder_columns(merge_df, 'avg_text', position=4)
